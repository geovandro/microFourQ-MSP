...
*
* Abstract: portable modular arithmetic and other low-level operations for MSP430X
* 
...
extern void mod_sqr128(felm_t a,felm_t c);
...
extern void fpmul1271(felm_t a, felm_t b, felm_t c);
extern void mod1271(felm_t a);
extern void mp_add128(const digit_t* a, const digit_t* b, digit_t* c);
extern void mp_mul(const digit_t* a, const digit_t* b, digit_t* c, const unsigned int nwords);
extern unsigned int mp_add( const digit_t* a, const digit_t* b, digit_t* c, const unsigned int nwords);
...
#if defined(USE_ASM)
    mp_mul(c, &a, &b, (8*sizeof(digit_t)+15)/16);
#else
